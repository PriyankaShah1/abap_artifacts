...
CLASS lhc_PO_IT IMPLEMENTATION.
  ...
  METHOD update.
    ...
    SELECT * FROM ztb_po_items FOR ALL ENTRIES IN @entities
    WHERE po_num = @entities-PoNum INTO TABLE @lt_po_items.
  ...
  METHOD delete.
    ...
    IF sy-subrc = 0.
      ...
      DELETE FROM ztb_po_items WHERE po_num EQ @<lfs_keys>-PoNum
                                AND po_item EQ @<lfs_keys>-PoItem.
